  ...
  <div class="goodsDetail">
    ...
    <div class="carousel">
      <swiper :options="swiperOption" ref="mySwiper">
        <swiper-slide v-for="(item,index) in swiperData" :key="index">
          <img class="myswiper_img" :src="item" alt @click="swiperImgClick" />
        </swiper-slide>
    ...
    <div class="product_meta">
      <div class="price_meta">
        ...
        <div class="sell_num">已销 9999件</div>
      </div>
    ...
    <div class="produce_size">
      ...
      <div class="size_content">
        <div
          class="size_item"
          :class="{size_item_on:activeIndex===index}"
    ...
    <div class="shopcart">
      ...
      <div class="shopcart_add" @click="addCart">加入购物车</div>
    </div>
  </div>
</template>
<script>

<template>
  <div class="classify">
    ...
    <div class="topNav">
      ...
      <div class="iconfont" @click="goHome">&#xe68d;</div>
    </div>
    <!-- 主体 -->
    <div class="main" :style="{height:mainHeight}">
      <!-- 主体左侧 -->
      <div class="mainLeft" ref="wrapper">
        <div class="content">
          <div
            class="item"
      ...
      <!-- 主体右侧 -->
      <div class="mainRight" ref="wrapper2">
        <div class="content">
          <!-- 顶部图 -->
          ...
          <div class="container" v-for="(item,index) in menuDetail.details" :key="index">
            ...
            <div class="content">
              <div
                class="content_item"
                @click="$router.push({ path: '/goodsDetail' })"
        ...
        .content {
          ...
          .content_item {
            ...
            .txt {
              text-align: center;
              font-size: @sizeS;
              padding: 0.29333rem 0 0.666667rem 0;
            }
          }
        }
      }
